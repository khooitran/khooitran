...
export const archive = {
  en: {
    title: 'Archive',
    description:
      'This page is home to the various experiments, explorations, tests, discontinued projects, side projects, and everything else from me that is related. Hopefully one of these will come in handy in a later project.',
